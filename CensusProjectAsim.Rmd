...
```{r}
ggplot(data, aes(x=data$workclass,fill=data$income)) + geom_bar(position = "stack", color = "black") + ggtitle('     Income levels in different Work Class')+ theme(axis.text.x=element_text(angle = 70 , hjust= 1, size=7)) 
